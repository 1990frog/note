...
两句在名词 river 上重复而建立关系，可以把句 2 中的 river 改写为关系代名词 which，然后把介系词短语 in which 移到句首扮演连接词角色，成为关系子句 in which the deadly pirana roam，再将关系子句置于句 1 的先行词 river 之后，就成为下面这个复句：
...
从属连接词 if 引导的副词子句，动词的语气是表示「过去时间非事实」的假设语气。动词短语 had been 包括文法助动词 had，可以选择把 had 倒装到句首，以这种方式取代连接词、省略掉从属连接词 if，如下：
