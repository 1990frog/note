...
-v=/mysqltest/data:/var/lib/mysql：映射数据目录
 ...
 docker run -d -p 3306:3306 -v /home/cai/Code/docker/mysql/conf/:/etc/mysql/conf.d/ -v /home/cai/Code/docker/mysql/db/:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=root --name mysql mysql
