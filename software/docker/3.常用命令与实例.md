...
## mysql
```
> docker run -d -p 3306:3306 -v /配置文件/:/etc/mysql/conf.d/ -v /数据库文件/:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=root --name mysql mysql
```
...
docker run -d -p18848:8848 -p17077:7077 -p15000:5000 --add-host=pig-register:127.0.0.1 --add-host=pig-gataway:127.0.0.1 --add-host=pig-upms-biz:127.0.0.1 --add-host=pig-auth:127.0.0.1 --add-host=pig-mysql:172.17.0.1 --add-host=pig-redis:172.17.0.1 --name dataquality dataquality