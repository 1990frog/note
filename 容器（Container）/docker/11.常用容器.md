...
docker run -itd --restart=always --name dqredis -p6379:6379 redis --requirepass P@ssw0rd123 

docker run -itd -p3306:3306 -e MYSQL_ROOT_PASSWORD=P@ssw0rd123 -e MYSQL_ROOT_HOST="%" --restart=always --name pig-mysql pig-mysql   

docker run -itd -p8848:8848 -p9999:9999 --restart=always -e NOSQL_HOST=mongodb -e DB_PWD=P@ssw0rd123 -e REDIS_PWD=P@ssw0rd123 --name dq-service dq-service
